	...
	<ul class="right_menu">
		...
		<li>   <button type="button" onclick="window.location.href='<?php echo base_url('home/word_lists'); ?>'" class="btn btn-success menubtn">Content List</button></li>
		...
		<li>  <button type="button" class="btn btn-success menubtn">Function</button></li>
